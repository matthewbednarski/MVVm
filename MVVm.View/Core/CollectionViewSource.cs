...
// https://code.google.com/p/mono-soc-2007/source/browse/trunk/george/Source/PresentationFramework/System.Windows.Data/CollectionView.cs?r=1232

namespace MVVm.Core
{
	public class CollectionViewSource : DispatcherObject, ICollectionView, IEnumerable, INotifyCollectionChanged, INotifyPropertyChanged
	{
		public static ICollectionView GetDefaultView<T>(ObservableCollection<T> coll)
		{
			return new CollectionViewSource (coll);
		}
		...
		public CollectionViewSource (IEnumerable collection)
		{
			if (collection == null)
		...
		{
			CollectionViewSource owner;

			public DeferHelper (CollectionViewSource owner)
			{
				this.owner = owner;
